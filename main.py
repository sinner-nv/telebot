...
def list_ofd(ofd_name):
   ...
   ofd_spisok = {
        'такском': ['ООО \"Такском\"', '7704211201', '193.0.214.11', 'f1.taxcom.ru', '7777', 'noreply@taxcom.ru'],
        'офд': ['ООО \"ПС СТ\"', '7841465198', '94.143.160.11', 'gate.ofd.ru', '4001', 'feedback@ofd.ru'],
        'первый': ['ООО \"Первый ОФД\"', '7709364346', '91.107.114.010', 'k-server.1-ofd.ru', '7777', 'info@1-ofd.ru'],
        'платформа': ['ООО \"Эвотор ОФД\"', '9715260691', '185.170.204.091', 'ofdp.platformaofd.ru', '21101', 'info@platformaofd.ru'],
        'ярус': ['ООО \"Ярус\"', '7728699517', '091.107.067.212', 'f1.taxcom.ru', '7779', 'help@ofd-ya.ru'],
        'яндекс': ['ООО \"Яндекс ОФД\"', '7704358518', '185.032.186.252', 'kkt.ofd.yandex.net', '12345', 'askofd@support.yandex.ru'],
        'астрал': ['ЗАО \"Калуга Астрал\"', '4029017981', '091.239.005.068', 'ofd.astralnalog.ru', '7777', 'client@astralnalog.ru'],
        'сбис': ['ООО \"Компания "ТЕНЗОР\"', '7605016030', '091.213.144.029', 'kkt.sbis.ru', '7777', 'noreply@sbis.ru'],
        ...
        'контур': ['ООО \"Контур НТТ\"', '6658497833', '046.017.204.250', 'ofd.kontur.ru', '7777', 'noreply@kontru.ru'],
...
def callback_worker(call):
    ...
    msg_taxcom = 'Название: {0}\n' \
                 ...
                 'DNS имя:   {3}\n' \
                 'Порт:          {4}\n' \
                 'EMAIL:        {5} '.format(set_ofd[0], set_ofd[1], set_ofd[2], set_ofd[3], set_ofd[4], set_ofd[5])
